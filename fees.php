...
{
$errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Success!</strong> Payement Validé</div>";
}
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Payements  
...
<form class="form-inline" role="form" id="searchform">
  ...
  <button type="reset" class="btn btn-danger btn-sm" id="clear" > Vider </button>
</form>
</fieldset>
...
function mydatatable()
{
              ...
              $("#subjectresult").html('<table class="table table-striped table-bordered table-hover" id="tSortable22"><thead><tr><th>Nom/Contact</th><th>Payements</th><th>Solde</th><th>Classe</th><th>DA</th><th>Action</th></tr></thead><tbody></tbody></table>');
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Voir Plus</h4>
        </div>
