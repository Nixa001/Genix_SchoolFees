...
$error = '<div class="alert alert-danger">
  ...
  <strong>Error!</strong> Ancien mot de passe incorrect !
</div>';
}
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Paramétre</h1>
...
?>
               ...
               <div class="panel panel-primary">
						...
						<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label" for="Confirm">Confirmer Mot de passe</label>
								<div class="col-sm-5">
