...
{
$errormsg = "<div class='alert alert-success'><strong>Success!</strong> Classe Ajouter</div>";
}else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="2")
{
$errormsg = "<div class='alert alert-success'><strong>Success!</strong> Classe Modifié</div>";
}
else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="3")
{
$errormsg = "<div class='alert alert-success'><strong>Success!</strong> Classe Supprimer</div>";
}
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Classe  
						<?php
...
?>
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
                        <div class="panel-heading">
                           <?php echo ($action=="add")? "Nouvelle Classe": "Modifier Classe"; ?>
                        </div>
		...
		$( document ).ready( function () {			
			 ...
			 if($("#signupForm1").length > 0)
         {
			$( "#signupForm1" ).validate( {
				...
				messages: {
					branch: "Saisir le nom de la classe",
					address: "Saisir l'adresse"
                             ...
                             <div class="table-sorting table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
									...
									echo '<tr>
											...
											<a onclick="return confirm(\'Etes vous de vouloir supprimer\');" href="branch.php?action=delete&id='.$r['id'].'" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span></a> </td>
                                        </tr>';
										$i++;
									}
									?>
    ...
    <div id="footer-sec">
       Genix Payment | Developed By : <a href="http://www.nicolasfaye.epizy.com/" target="_blank">Nixa001</a>
    </div>
